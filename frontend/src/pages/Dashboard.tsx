...
//   Table, Thead, Tr, Th, Tbody, Td, Button, HStack, Skeleton, Text, Link
...
//     language:string; verdict:string; execution_time:number; submitted_at:string;
//   }[];
// };

// const MBox = motion(Box); // Chakra Box with motion
...
//     (async ()=>{
//       try {
//         const r = await api.get('/me/summary/');
...
//   // If user isn't logged in, show CTA instead of redirecting abruptly
//   if (!authed) {
//     return (
//       <Box p={10} color="white">
//         <Heading size="lg" mb={4}>Welcome to your Dashboard</Heading>
//         <Text mb={6} color="gray.300">Log in to see your stats, recent submissions and quick actions.</Text>
//         <HStack>
//           <Button as={RouterLink} to="/login" colorScheme="teal">Login</Button>
//           <Button as={RouterLink} to="/register" variant="outline" colorScheme="teal">Create account</Button>
//         </HStack>
//       </Box>
//     );
//   }
...
//         <HStack>
//           <Button as={RouterLink} to="/problems" colorScheme="teal">Solve Problems</Button>
...
//               <StatHelpText>
//                 {Object.entries(data?.difficulty_breakdown || {}).length
...
//               <Text color="gray.400">No submissions yet. <Link as={RouterLink} to="/problems" color="teal.200">Start solving →</Link></Text>
//             ) : (
