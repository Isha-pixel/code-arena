...
// //       <Heading mb={4}>Submissions</Heading>
// //       <Box className="glass" p={6} rounded="lg">
// //         <Text color="gray.400">Hook this to your /api/submissions/ list.</Text>
// //       </Box>
// //     </Container>
// //   );
// // }
...
// type S = { id:number; problem:string; code:string; language:string; verdict:string; execution_time:number; submitted_at:string };
...
//     setItems(r.data || []);
//   })(); },[]);
//   const color=(v:string)=> (v==='AC'||v==='Accepted')?'green':'red';
//   return (
//     <Box p={8} color="white">
//       <Heading size="lg" mb={4}>My Submissions</Heading>
//       <Table variant="simple" colorScheme="gray" size="sm">
//         <Thead><Tr><Th>#</Th><Th>Problem</Th><Th>Lang</Th><Th>Verdict</Th><Th isNumeric>Time (s)</Th><Th>When</Th></Tr></Thead>
//         <Tbody>
//           {items.map((s,i)=>(
//             <Tr key={s.id}>
//               <Td>{i+1}</Td>
//               <Td>{s.problem}</Td>
//               <Td>{s.language}</Td>
//               <Td><Tag colorScheme={color(s.verdict)}>{s.verdict}</Tag></Td>
